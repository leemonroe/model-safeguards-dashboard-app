...
const PARAM_RANGES = [
  ...
  { key: "stepsToCircumvent", label: "Steps to circumvent safeguard", lo: 100, hi: 1e5, log: true,
    src: "MC range assumes some safeguard is present. Lower: post-training methods (~100-500). Upper: next-gen methods (~100K). TAR: ~1K-5K. Deep Ignorance: ~10K." },
